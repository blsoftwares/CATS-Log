			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
                    ...
                    <p>&nbsp;</p>
                                ...
                                <p>&nbsp;&nbsp;&nbsp;&nbsp;The site manager for the site <?php echo $data['site_name'];?> has completed their registration process (i.e., site manager registration and site engagement form). The site details are mentioned below:</p>
 <p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;Now, you can see the site overview on your dashboard menu [appears on the left panel after you login to the CA|TS-Log website].</p>
<p><hr/></p>
<p>Thanks & Regards,</p>
