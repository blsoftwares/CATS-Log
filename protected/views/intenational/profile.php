...
<div class="row">
    ...
    <div class="form-group">
												...
												<div class="col-md-8">
                                                        ...
                                                        <?php echo $form->textField($model,'email',array('class'=>'form-control','size'=>60,'maxlength'=>200,"autocomplete"=>$model->email)); ?>
		...
		<?php echo $form->passwordField($model,'password',array("class"=>"form-control","autocomplete"=>$model->password)); ?>
