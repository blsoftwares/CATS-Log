       ...
       'enctype'=>'multipart/form-data'
                        ...
                        <header class="panel-heading">
                                        ...
                                        <?php $status= ($siteData->status==0)?'':'checked="checked"'; ?>
											...
											$("#SiteCriteriaHistory_ad_comment").attr('readonly',true);
											$("#SiteCriteriaHistory_nc_comment").attr('readonly',true);
											$("#SiteCriteriaHistory_ic_comment").attr('readonly',true);
											})
