...
<div class="">
	...
	{
		$("#SiteCriteriaHistory_assesment").val('<?php echo $model->assesment; ?>');
		$("#SiteCriteriaHistory_assesment").attr('readonly',false);
		$("#SiteCriteriaHistory_source_base").val('<?php echo $model->source_base; ?>');
...
<?php echo $form->textArea($model,'assesment',array("class"=>"form-control",'rows'=>6, 'cols'=>50)); ?>
...
<?php echo $form->textArea($model,'source_base',array("class"=>"form-control",'rows'=>6, 'cols'=>50)); ?>

                                                
                                                
		<?php echo $form->error($model,'source_base',array('class'=>'text-danger')); ?>
												</div>
											</div>
...
No Rating Given / Not Applicable
                                    ...
                                    <div id="fileupload" class="col-md-4">
                                     <header class="panel-heading">
										...
										<h2 class="panel-title">Attach Documents</h2>
                                         <br />
                                        <?php 
										$size=((5-$sizelimit)>0)?(5-$sizelimit):0;
									...
									for($i=1;$i<=10;$i++){
                                     ...
                                     <div class="form-group">
												  ...
												  <?php if($files['file'.$i]!="") {?>	
                                                  <a target="_blank" href="<?php echo Yii::app()->baseUrl.'/sitedata/'.Yii::app()->user->userid.'/'.$criteriaData['criteria_id'].'/'.$files['file'.$i];?>" download><i class="fa fa-file"></i> <?php echo $files['filename'.$i];?> </a><?php 
echo CHtml::ajaxButton(
        "X",
		
        array('site/deleteImageFromUpdate','id'=>$model->id,'fileid'=>'file'.$i),
