...
<div class="row">
	...
	<div class="form-group">
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="inputDefault">Site Manager Name *</label>
												<div class="col-md-8">
		...
		<span class="icon" onclick="changeType();"><i class="fa fa-eye"></i></span>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
                                                        ...
                                                        <p class="form-control"><?php echo $model->site_country;?></p>
...
$("#SiteRegister_profileimage").change(function() {
  readURL(this);
		...
		function changeType()
    {
	$type=$('#SiteRegister_password').attr('type');
     if($type=="text") 
		$('#SiteRegister_password').attr('type','password');
	if($type=="password")
		$('#SiteRegister_password').attr('type','text');
