										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="<?php echo Yii::app()->baseUrl;?>/assets/images/!logged-user.jpg">
												</div>
														...
														<ul class="simple-user-list mb-xlg">
															<li>
																<figure class="image rounded">
																	<img src="<?php echo Yii::app()->baseUrl;?>/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle">
																</figure>
															...
															<li>
																<figure class="image rounded">
																	<img src="<?php echo Yii::app()->baseUrl;?>/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle">
																</figure>
															...
															<li>
																<figure class="image rounded">
																	<img src="<?php echo Yii::app()->baseUrl;?>/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle">
																</figure>
													...
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="<?php echo Yii::app()->baseUrl;?>/assets/images/projects/project-4.jpg">
																<span class="zoom">
