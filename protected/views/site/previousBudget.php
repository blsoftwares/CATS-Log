             ...
             <!-- Pillar Rtaing Chart -->
						<div class="col-lg-12 col-md-12">
                            ...
                            <header class="panel-heading">
                                        ...
                                        <center><h2 class="panel-title">Site Budget Allocation For Previous FY</h2></center>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php
			$test_list=array((date('Y')-3)=>(date('Y')-3)."-".(date('y')-2),(date('Y')-2)=>(date('Y')-2)."-".(date('y')-1),(date('Y')-1)=>(date('Y')-1)."-".(date('y')));
echo $form->dropDownList($model, 'financial_year', $test_list,array('empty'=>'-Financial Year -','class'=>'form-control select2'));
		?>
