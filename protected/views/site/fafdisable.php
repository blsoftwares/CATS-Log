...
<div class="">
                        ...
                        <?php if($site->cats_status==0 && $site->cats_level!="0.0.0"){?>
                        
                        <div class="alert alert-info"><center> Site needs some Improvement </center></div>
                        
                        <?php } ?>
                      
                        <?php if($model->assesment==""){?>
                        
                        <div class="alert alert-info"><center> Site is in Transit Phase</center></div>
	...
	'enableAjaxValidation'=>false,
                        ...
                        <header class="panel-heading">
                                        ...
                                        <?php $status= ($model->status==0)?'':'checked="checked"'; ?>
											...
											$("#assesment").attr('readonly',true);
											$("#source_base").attr('readonly',true);
											})
...
<textarea class="form-control" rows="6" cols="50" name="assesment" id="assesment"><?php echo $model->assesment;?></textarea>
                     
		<?php echo $form->error($model,'assesment',array('class'=>'text-danger')); ?>
												</div>
											</div>
                                     ...
                                     <textarea class="form-control" rows="6" cols="50" name="source_base" id="source_base"><?php echo $model->source_base;?></textarea>           
                                 ...
                                 <div class="modal-content">    
                                  ...
                                  <button type="button" class="close" data-dismiss="modal">&times;</button>       
                                   <h4 class="modal-title">Assessment History</h4>      
                                    ...
                                    <div class="modal-body" id="assesmentHistory" style="height:300px;overflow:auto;">        <p><?php echo $this->renderPartial('/site/assesmentHistory',array('site_id'=>$model->site_id,'criteria_id'=>$criteriaData['criteria_id']))?></p>     
                                     </div>      
...
?> <br />(Score  :<?php echo ($model->rating>0)?(float)$model->points:'N.A.';?>)
...
No Rating Given / Not Applicable
									...
									for($i=1;$i<=10;$i++){
                                     ...
                                     <div class="form-group">
												  ...
												  <?php if($files['file'.$i]!="") {?>	
                                                  <a target="_blank" href="<?php echo Yii::app()->baseUrl.'/sitedata/'.Yii::app()->user->userid.'/'.$criteriaData['criteria_id'].'/'.$files['file'.$i];?>" download><i class="fa fa-file"></i> <?php echo $files['filename'.$i];?> </a>
    ...
    <input type="file" name="file<?php echo $i;?>" class="fileupload"  id="file<?php echo $i;?>">
                         ...
                         <script>
											var size=0;
											var maxsize=<?php echo round($size,2) ;?>;
