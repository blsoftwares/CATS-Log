...
font-weight:normal !important;
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>CA|TS Log Engagement Details</h2>
...
<div class="row">
						...
						<p><?php echo $msg;?>
</p>										<h2 class="panel-title">CA|TS Log Engagement Form</h2>
                                       <p><?php if($model->status==0) echo '<font color="#006633">Your engagement form submitted successfully. Subjected to verification by National Committee.</font>';?></p>
									</header>
    ...
    <div style="color:#F00;"><?php echo $form->errorSummary($model); ?></div>
    <hr />
    <?php }?>
	...
	<div class="form-group   col-md-6">
		...
		<span class="icon">per sq km</span>
		</span>
		</div>
    ...
    <div class="form-group col-md-6">
      ...
      <div class="form-group  col-md-6">
		...
		<div class="col-md-6"><?php if(!empty($model->site_image)) {?>
        <a href="<?php echo Yii::app()->baseUrl;?>/img/site_documents/site_image/<?php echo $model->site_image;?>" class="btn btn-primary btn-xs " download>Download File</a>
        <?php } ?></div><div class="col-md-6"> <?php echo $form->fileField($model,'site_image',array('size'=>60,'maxlength'=>100,'style'=>"width: 85px;" ,'onchange'=>"this.style.width = '100%';" )); ?></div>
...
?>
		...
		<?php //echo $form->textArea($model,'population_trend',array("class"=>"form-control",'size'=>60)); ?>
...
<div>
   ...
   <p></strong>By completing and signing this form as the official representative of the conservation / protected area you are registering the site for CA|TS Log and hereby agree to work towards achieving CA|TS Log Approved status	</strong>	
	...
	<div class="form-group buttons">
		<center><?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Update',array('class'=>'btn btn-primary','onclick'=>"this.disabled=true;this.value='Updating profile. Please wait....';this.form.submit();" )); ?></center>
	</div>
