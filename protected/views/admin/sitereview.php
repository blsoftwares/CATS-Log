...
<section role="main" class="content-body" id="print">
					...
					<header class="page-header">
						<h2><span <?php if($model['cats_status']==4)echo 'style="background:#030"';?>><?php echo $model['name_cpa'];?></span></h2>
						...
						<div class="col-lg-6 col-md-12">
							<section class="panel">
								<header class="panel-heading panel-heading-transparent">
									...
									<h2 class="panel-title"><?php echo CatsPillar::model()->truncate($stlist['standard_name']);?> | Rating : <?php echo number_format($standardRating['rating'],2);?> | Score : <?php echo $standardPoint;?></h2>
              ...
              <div class="row">
               ...
               <section class="panel">
                                    ...
                                    <header class="panel-heading">
										...
										<h2 class="panel-title">Submit this site for CA|TS Log approval/review to national committee</h2>
                                        <p>Once you submit your site for approval; you are not able to do any further assesment </p>
									</header>
									<div class="panel-body">
                                    <?php 
									$checkSite=SiteElementHistory::model()->checkSite($model,4);
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Are you confirm to submit the site for review to National Committee?</h4>
      </div>
...
<?php echo $form->textArea($model,'adfinalcomment',array("class"=>"form-control",'rows'=>6, 'cols'=>50,'required'=>true)); ?>
...
<?php }else{?>
 ...
 <?php
  if(date('d-m-Y',strtotime($pdates['actiondate']))>date('d-m-Y')){?>
						...
						<div class="form-group col-md-6">
                                <form method="post" action="<?php echo Yii::app()->createUrl('admin/backup');?>">
...
<center><p style="color:#060;">CA|TS Log approval is in process to National Committee .</p></center>
<?php }?>
