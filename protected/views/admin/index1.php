...
Criteria Rating:
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>Site 1</option>
															<option value="Porto Drupal" >Site 2</option>
															<option value="Porto Wordpress" >Site 3</option>
														</select>
													</strong>
												</h2>
										...
										<div class="col-lg-4 text-center">
											<h2 class="panel-title mt-md">CA|TS Log Goal (100)</h2>
