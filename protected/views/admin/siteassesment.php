...
<script src="<?php echo Yii::app()->baseUrl;?>/js/jquery.table2excel.js"></script>
<script>
...
function exportData()
{
    ...
    name: "Assesment Data",
    filename: "<?php echo $model['name_cpa'];?>" //do not include extension
});
}
                    ...
                    <div class="row">
						...
						<div class="col-lg-12 col-md-12">
                           ...
                           <header class="panel-heading">														
								<h2 class="panel-title">Complete Self Assesment Data</h2>

<button type="button" onclick="exportData()">Export Excel</button>                               
							</header>
                                <div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none" id="export">
										<thead>
											<tr>
												<th>S.No.</th>
												<th>Pillar</th>
