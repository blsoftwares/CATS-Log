...
<section role="main" class="content-body">
                    ...
                    <div class="row">
                    <?php 
		 $sql="Select * FROM site_register Where cats_status>=1 and profile=1 and status=1  and site_id IN (SELECT site_id FROM reviewer_site WHERE reviewer_id=".Yii::app()->user->admin_id.")";
             ...
             <div class="col-lg-12 col-md-12">
							<section class="panel">
								<header class="panel-heading">
										...
										<center><h2 class="panel-title"><a href="<?php echo Yii::app()->createUrl('admin/review',array('sitecode'=>$list['site_id']));?>"><?php echo $list['name_cpa'];?></a> :: <?php echo SiteRegister::model()->getSiteStatus($list['cats_status'],$list['site_id']); ?></h2></center>
