...
<div class="">
                       ...
                       <div class="alert alert-info"><center>This Site is in Transit Phase</center></div>
...
<textarea class="form-control" rows="6" cols="50" name="assesment" id="assesment"><?php echo $siteData->assesment;?></textarea>
...
<textarea class="form-control" rows="6" cols="50" name="source_base" id="source_base"><?php echo $siteData->source_base;?></textarea>
                                   ...
                                   <h4 class="modal-title">Assessment History</h4>      
                                    ...
                                    <div class="modal-body" id="assesmentHistory" style="height:300px;overflow:auto;">        <p><?php echo $this->renderPartial('/site/assesmentHistory',array('site_id'=>$site->site_id,'criteria_id'=>$criteriaData['criteria_id']))?></p>     
                                     ...
                                     <div class="form-group">
												...
												<div class="">
<textarea class="form-control" rows="3" cols="50" name="ad_comment" id="ad_comment"><?php echo $siteData->ad_comment;?></textarea>
...
No Rating Given / Not Applicable
									...
									for($i=1;$i<=10;$i++){
                                     ...
                                     <div class="form-group">
												  ...
												  <?php if($files['file'.$i]!="") {?>	
                                                  <a target="_blank" href="<?php echo Yii::app()->baseUrl.'/sitedata/'.$site['site_id'].'/'.$criteriaData['criteria_id'].'/'.$files['file'.$i];?>" download><i class="fa fa-file"></i> <?php echo $files['filename'.$i];?> </a><a target="_blank" href="<?php echo Yii::app()->baseUrl.'/sitedata/'. $site['site_id'].'/'.$criteriaData['criteria_id'].'/'.$files['file'.$i];?>"  style="color:#F00;"> <i class="fa fa-times"></i></a>
    ...
    <input type="file" name="file<?php echo $i;?>" class="fileupload"  id="file<?php echo $i;?>">
                         ...
                         <script>
											var size=0;
											var maxsize=<?php echo round(5-$size,2) ;?>;
