...
<html class="fixed">
	<head>
		...
		<title>CA|TS Log Online Portal | Site Assesment | Audit</title>
...
$(window).on('load',function() {
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								...
								<span class="role">CATS Admin</span>
							</div>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('catsadmin/profile')?>"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
								...
								<ul class="nav nav-main">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('catsadmin/review',array('sitecode'=>$_GET['sitecode']))?>">
								   ...
								   foreach($ele as $slist){
                                    ...
                                    <li class="nav-parent <?php if(($aid=="reviewcriteria" || $aid=="reviewelement" || $aid=="reviewstandard")&&($_GET['element']==$eid)) echo 'nav-expanded';?>">
                                        ...
                                        <li class="<?php if(($aid=="reviewelement")&&($_GET['element']==$eid)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('national/reviewelement',array('element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for Element <?php echo $slist['element_id']?> </a>
 ...
 <?php echo CatsPillar::model()->truncate($stlist['standard_name']);?></a>
                                                ...
                                                <li  class="<?php if(($aid=="reviewstandard")&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('national/reviewstandard',array('standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for <?php echo CatsPillar::model()->truncate($stlist['standard_name'])?> </a>
                                                ...
                                                foreach($cats as $clist){
													...
													<li class="<?php if(($aid=="reviewcriteria")&&($_GET['criteria']==$cat)&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('national/reviewcriteria',array('criteria'=>$cat,'standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>"><?php echo CatsPillar::model()->truncate($clist['criteria_name']);?></a>
