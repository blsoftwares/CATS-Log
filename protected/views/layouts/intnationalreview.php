...
<html class="fixed">
	<head>
		...
		<title>CA|TS Log Online Portal | Site Assesment | International Committee</title>
...
$(window).on('load',function() {
				...
				<div class="header-right">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<?php
							$site=UserLogin::model()->findByAttributes(array('email'=>Yii::app()->user->incm_email));
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								<span class="name"><?php echo UserLogin::model()->getNameById(Yii::app()->user->incm_id);?></span>
								<span class="role">International Committee</span>
							</div>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('intenational/profile')?>"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
							...
							<nav id="menu" class="nav-main" role="navigation">
								...
								<ul class="nav nav-main">
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('intenational/index')?>">
                                     ...
                                     <li>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('intenational/review',array('sitecode'=>$_GET['sitecode']))?>">
											<i class="fa fa-tasks" aria-hidden="true"></i>

											<span>Site Summary and Approval</span>
										</a>
                                    ...
                                    <li class=" <?php if($aid=="review") echo 'nav-active';?>">									
                                        ...
                                        <a>
											...
											<span>CA|TS Log Assesment Sections</span>
										</a>
									</li>
								   ...
								   foreach($ele as $slist){
                                    ...
                                    <li class="nav-parent <?php if(($aid=="reviewcriteria" || $aid=="reviewelement" || $aid=="reviewstandard")&&($_GET['element']==$eid)) echo 'nav-expanded';?>">
                                        ...
                                        <li class="<?php if(($aid=="reviewelement")&&($_GET['element']==$eid)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('intenational/reviewelement',array('element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for Element <?php echo $slist['element_id']?> </a>
 ...
 <?php echo CatsPillar::model()->truncate($stlist['standard_name']);?></a>
                                                ...
                                                <li  class="<?php if(($aid=="reviewstandard")&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('intenational/reviewstandard',array('standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for <?php echo CatsPillar::model()->truncate($stlist['standard_name'])?> </a>
                                                ...
                                                foreach($cats as $clist){
													...
													<li class="<?php if(($aid=="reviewcriteria")&&($_GET['criteria']==$cat)&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('intenational/reviewcriteria',array('criteria'=>$cat,'standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>"><?php echo CatsPillar::model()->truncate($clist['criteria_name']);?></a>
