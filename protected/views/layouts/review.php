...
<html class="fixed">
	<head>
		...
		<title>CA|TS Log Online Portal | Site Assesment | Reviewer</title>
		<meta name="keywords" content="CA|TS Log Log" />
		<meta name="description" content="BLS Admin - Responsive HTML5 Template">
		<meta name="author" content="blsoftwares.com">
		<!-- Mobile Metas -->
...
$(window).on('load',function() {
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								 <?php
							$site=UserLogin::model()->findByAttributes(array('email'=>Yii::app()->user->admin_email));
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								<span class="name"><?php echo UserLogin::model()->getNameById(Yii::app()->user->admin_id);?></span>
								<span class="role">Site Reviewer</span>
							</div>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('admin/profile')?>"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
								...
								<ul class="nav nav-main">
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('admin/index')?>">
											...
											<span>Regsitered Sites List</span>
										</a>
                                        
									</li>
                                    
                                                                       
                                     <li class=" <?php if($aid=="review") echo 'nav-active';?>">
										

                                        <a href="<?php echo Yii::app()->createUrl('admin/review',array('sitecode'=>$_GET['sitecode']))?>">
											<i class="fa fa-university" aria-hidden="true"></i>

											<span>CA|TS Log Site Summary</span>
										</a>
								   ...
								   foreach($ele as $slist){
									   ...
									   ?>
                                    <li class="nav-parent <?php if(($aid=="reviewcriteria" || $aid=="reviewelement" || $aid=="reviewstandard")&&($_GET['element']==$eid)) echo 'nav-expanded';?>">
										<a>
											<?php echo CatsElement::model()->getCriteriaReviewerStatus($slist['element_id'],$_GET['sitecode']);?>
											<span>Element <?php echo $slist['element_id'];?></span>
										</a>
										<ul class="nav nav-children" style="">
                                        
                                        <li class="<?php if(($aid=="reviewelement")&&($_GET['element']==$eid)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('admin/reviewelement',array('element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for Element <?php echo $slist['element_id']?> </a>
									...
									foreach($stn as $stlist){
										...
										?>
											<li class="nav-parent <?php if(($aid=="reviewstandard" || $aid=="reviewcriteria")&&($_GET['standard']== $stand)) echo 'nav-expanded';?>">
												<a><?php echo CatsStandard::model()->getCriteriaReviewerStatus($stand,$_GET['sitecode']);?>
 <?php echo CatsPillar::model()->truncate($stlist['standard_name']);?></a>
                                                ...
                                                <li  class="<?php if(($aid=="reviewstandard")&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('admin/reviewstandard',array('standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>">Summary for <?php echo CatsPillar::model()->truncate($stlist['standard_name'])?> </a>
                                                ...
                                                foreach($cats as $clist){
													$cat=$clist['criteria_id'];
													 ?>
													<li class="<?php if(($aid=="reviewcriteria")&&($_GET['criteria']==$cat)&&($_GET['standard']==$stand)) echo 'nav-active';?>">
														<a href="<?php echo Yii::app()->createUrl('admin/reviewcriteria',array('criteria'=>$cat,'standard'=>$stand,'element'=>$slist['element_id'],'sitecode'=>$_GET['sitecode']));?>"><?php echo CatsCriteria::model()->getCriteriaReviewerMenu($cat,$_GET['sitecode']);?> <?php echo CatsPillar::model()->truncate($clist['criteria_name']);?></a>
...
$( document ).ready(function() {
  ...
  $('#stars-existing').on('starrr:change', function(e, value){
    $('#count-existing').html(value);
		...
		<script src="<?php echo Yii::app()->baseUrl;?>/assets/javascripts/ui-elements/examples.charts.js"></script>
